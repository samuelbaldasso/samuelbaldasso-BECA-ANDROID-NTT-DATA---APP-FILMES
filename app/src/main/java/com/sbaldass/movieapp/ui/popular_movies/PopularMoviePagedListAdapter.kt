...
import com.sbaldass.movieapp.R
import com.sbaldass.movieapp.data.api.POSTER_BASE_URL
import com.sbaldass.movieapp.data.repository.NetworkState
import com.sbaldass.movieapp.data.vo.Movie
import com.sbaldass.movieapp.ui.single_movie_details.SingleMovie
...
class PopularMoviePagedListAdapter(public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback()) {
    ...
    class MovieItemViewHolder (view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(movie: Movie?,context: Context) {
            ...
            itemView.cv_movie_releaseDate.text =  movie?.release_date

            val moviePosterURL = POSTER_BASE_URL + movie?.poster_path
            Glide.with(itemView.context)
                .load(moviePosterURL)
                .into(itemView.cv_iv_moviePoster);
